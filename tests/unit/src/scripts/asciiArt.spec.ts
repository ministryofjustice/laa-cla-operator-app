...
describe("ASCII Art Banner", () => {
  ...
  it("should display a banner with the correct format", () => {
    ...
    ok(
      ...
      "Banner should include welcome message",
    );
    ok(
      output.includes("Like what you see? Want to work with us?"),
      "Banner should include recruitment message",
    );
    ok(
      output.includes("View our job availabilities"),
      "Banner should include job reference",
    );
  });
