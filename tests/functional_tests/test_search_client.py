...
def test_search_page_loads(search_page: Page):
    ...
    expect(page.get_by_role("heading", name="Search client's details", level=1)).to_be_visible()
...
def test_results_table_contains_expected_columns(search_page: Page, mock_search_backend):
    page = search_page
...
def test_search_results_return_20_results_per_page(search_page: Page, mock_search_backend):
    page = search_page
