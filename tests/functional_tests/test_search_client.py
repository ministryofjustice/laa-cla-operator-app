...
def test_search_results_are_displayed(search_page: Page):
    ...
    expect(page.locator(".govuk-table")).to_be_visible()

    expect(page.get_by_text("Client search results")).to_be_visible()
...
def test_clear_all_link_clears_fields(search_page: Page):
    ...
    expect(page.locator("#date_of_birth-issued-day")).to_have_value("")
    expect(page.locator("#date_of_birth-issued-month")).to_have_value("")
    expect(page.locator("#date_of_birth-issued-year")).to_have_value("")
